...
function sqlDatabaseHandler(db) {
  switch (db) {
    case "sqldb-connections-qa":
      ProjectSuite.Variables.dboDatabaseUser =
        ProjectSuite.Variables.dboEntitlementsUser;
      ProjectSuite.Variables.dboDatabasePass =
        ProjectSuite.Variables.dboEntitlementsPassQA;
      break;
    case "sqldb-connections-stg":
      ProjectSuite.Variables.dboDatabaseUser =
        ProjectSuite.Variables.dboEntitlementsUser;
      ProjectSuite.Variables.dboDatabasePass =
        ProjectSuite.Variables.dboEntitlementsPassSTG;
      break;
    ...
    case "sqldb-fx-qa":
      ...
      ProjectSuite.Variables.dboDatabasePass =
        ProjectSuite.Variables.dboFXPassQA;
      break;
    case "sqldb-fx-stg":
      ProjectSuite.Variables.dboDatabaseUser = ProjectSuite.Variables.dboFXUser;
      ProjectSuite.Variables.dboDatabasePass =
        ProjectSuite.Variables.dboFXPassSTG;
      break;

    case "sqldb-payments-qa":
      ProjectSuite.Variables.dboDatabaseUser =
        ProjectSuite.Variables.dboPaymentsUser;
      ProjectSuite.Variables.dboDatabasePass =
        ProjectSuite.Variables.dboPaymentsPassQA;
      break;
    case "sqldb-payments-stg":
      ProjectSuite.Variables.dboDatabaseUser =
        ProjectSuite.Variables.dboPaymentsUser;
      ProjectSuite.Variables.dboDatabasePass =
        ProjectSuite.Variables.dboPaymentsPassSTG;
      break;

    case "sqldb-transactions-qa":
      ProjectSuite.Variables.dboDatabaseUser =
        ProjectSuite.Variables.dboTransactionsUser;
      ProjectSuite.Variables.dboDatabasePass =
        ProjectSuite.Variables.dboTransactionsPassQA;
      break;
    case "sqldb-transactions-stg":
      ProjectSuite.Variables.dboDatabaseUser =
        ProjectSuite.Variables.dboTransactionsUser;
      ProjectSuite.Variables.dboDatabasePass =
        ProjectSuite.Variables.dboTransactionsPassSTG;
      break;
  }
  ...
  if (equal(ProjectSuite.Variables.Environment, "STG")) {
    ProjectSuite.Variables.dboDatabaseServer =
      "fg-sql-silvergate-apis-shared-stg";
  }
